    ...
    return (
        <div className='flex flex-col'>
            <div className="p-5 bg-lightMode-component dark:bg-darkMode-component mt-5 rounded-t-2xl shadow-sm flex flex-col text-lightMode-txt dark:text-darkMode-txt">
                ...
                <p className='mt-1'>
                    Post description:
                    Lorem, ipsum dolor sit amet consectetur adipisicing elit. Voluptates in asperiores itaque maiores vero veniam inventore, sequi alias culpa maxime qui explicabo nihil nesciunt rem modi officiis repudiandae, hic quos?
                </p>
            </div>
            ...
            <div className='flex flex-col rounded-b-2xl bg-lightMode-component dark:bg-darkMode-component text-neutral-700 dark:text-neutral-400 border-t p-2'>
                <div className='flex justify-between items-center gap-9 '>
                    ...
                    <button type='button' onClick={() => setShow(!show)} id="inputIcons" className="rounded-none gap-1 cursor-pointer">
